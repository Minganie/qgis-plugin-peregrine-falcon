...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'peregrinefalcon_dialog_base.ui'))


class PeregrineFalconDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(PeregrineFalconDialog, self).__init__(parent)
